        ...
        */
        ...
        if (remaining.gt(ZERO)) {
          ...
          logColumns([
            ...
            'Total in holding',
            '',
            poolQty.toFixed(8), // TODO: coupling
          ], {
            sizes: [0, 0, 3], // short = sign
          });
          log();
          logColumns([
            'Cost',
            `${this.currency.format(poolCost)} x ${remaining.toFixed(8)}`,
            '=',
        ...
        disposals.push({
          ...
          gain,
          toString: () => `${shortDate} | Sold ${t.qty} BTC | Gain/Loss ${this.currency.format(gain)}`,
        });
      }
