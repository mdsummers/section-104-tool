    ...
    for (let i = 0; i < trades.length; i++) {
      ...
      if (t.type === 'SELL') {
        ...
        for (const b of sameDayBuys) {
          ...
          allowableCost = allowableCost.plus(costPortion);
        ...
        */
        ...
        for (const b of futureBuys) {
          ...
          if (d > 0 && d <= 30) {
            ...
            const thisAllowableCost = proportionOfMatchedBuy.times(b.total);
            logColumns([
              'Allowable cost',
            ...
            const thisGain = matchedDisposalProceeds.minus(thisAllowableCost);
        ...
        disposals.push({
          ...
          taxYear,
          qty: t.qty,
          // TODO: Because proceeds already have fee removed, these aren't right
          // proceeds should have fee added, allowableCost should have it added
          // the gain will be unchanged
